...
const App = () => {
  const [user, setUser] = useState({
    propertyID:"", propertyAddress: "",bankDetailsChange:false, propertyOwnershipChange:false, accountNameChange:false,otherChange:false, propertyName: "", changeDescriptionDetails: "", reasonForChange: "",desiredOutcome: "", requestorID: "", requestorName: "", requestorJobTitle: "",date: "", urgent: false,critical:false,routine:false, uploads: "",
  ...
  const onSubmit = async (e) => {
      ...
      try {
          ...
          setLoading(true);
          const response = await axios.post("http://localhost:8001/api/changeRequest", validatedData);
